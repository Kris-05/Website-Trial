...
const Hero = () => {
  ...
  const getVideoSrc = (index) => `img/gallery-${index}.webp`;
  const totalVideos = 4;
  ...
  const handleVideoChange = () => {
    setHasClicked(true);
    setCurrIndex((prevIndex) => (prevIndex % totalVideos) + 1);
  }
  ...
  useGSAP(()=>{
    ...
    gsap.from('#video-frame', {
      ...
      // clipPath: 'polygon(0% 15%, 0 0, 15% 0%, 85% 0%, 100% 0, 100% 15%, 100% 85%, 100% 100%, 85% 100%, 15% 100%, 0 100%, 0% 85%)',
